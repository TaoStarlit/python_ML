...
# 查验数据规模和细节。
print "len(new.data): ", len(news.data)
print "new.data[0]: ", news.data[0]
print "new.target[0]: ", news.target[0]
...
import numpy as np
print "np.unique(y_train): ", np.unique(y_train, return_counts=True) #Find the unique elements of an array.
